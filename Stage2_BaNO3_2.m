function [Lambda,Lambda_dt]=Stage2_BaNO3_2(bulk,SBNCAN,V,upsilon,t1,t)
...
%第2项 代表Ba
    a2=upsilon .* SBNCAN.C0(2).* (t-t1);
    a2_dt=upsilon .* SBNCAN.C0(2);
...
%第4项 代表Cl
    ...
    Gamma=   Gamma    + 0.5 *SBNCAN.z(4)^2. * V * SBNCAN.C0(4) ./ (V + upsilon .*t );
...
Lambda=Lambda +SBNCAN.z(j) .* A2 ./ b;
Lambda_dt=Lambda_dt + SBNCAN.z(j) .* (A2_dt.*b - A2.*b_dt) ./ b.^2;
