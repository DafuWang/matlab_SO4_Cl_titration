function   [V_L,norm_V_L,V_L_dt,norm_V_L_dt,...
            ...
            =SO4_Norm_paramrters(k,upsilon,t_1,t_2,V3, ...
            ...
            figure(1);
            plot(Volume_all,Lambda_all,'LineWidth',1.5,'Color',color(k))
            ...
            figure(2)
            plot(Volume_dt_all,Lambda_dt_all,'LineWidth',1.5,'Color',color(k))
            set(0,'defaultfigurecolor','w');%设定背景颜色为白色
            set(gca,'FontSize',10,'Fontname', 'Times New Roman');
            xlabel('$Volume\:of\:titration (mL)$','Interpreter','latex','FontSize',15);
